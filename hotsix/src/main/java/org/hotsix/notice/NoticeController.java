...
public class NoticeController {
   ...
   public String registPOST(@ModelAttribute("cri")Criteria cri,MultipartFile file, NoticeVO vo,Model model)throws Exception{
   ...
   private String uploadFile(String originalName, byte[] fileData)throws Exception{
      ...
      makeThumbnail(uploadPath +savedPath,savedName, fileData);
...
private String calcPath(){
   ...
   private String makeThumbnail(String path, String fileName, byte[] data)throws Exception{
